...
with st.sidebar.expander(
    ...
    user_data["OverallQual"] = st.number_input(
        "Overall Quality",
        value=int(numeric_defaults["OverallQual"])
    )

    user_data["OverallCond"] = st.number_input(
        "Overall Condition",
        value=int(numeric_defaults["OverallCond"])
    )

    user_data["YearBuilt"] = st.number_input(
        "Year Built",
        value=int(numeric_defaults["YearBuilt"])
    )

    user_data["YearRemodAdd"] = st.number_input(
        "Year Remodeled",
        value=int(numeric_defaults["YearRemodAdd"])
    )
...
with st.sidebar.expander(
    ...
    user_data["GrLivArea"] = st.number_input(
        "Ground Living Area",
        value=float(numeric_defaults["GrLivArea"])
    )

    user_data["1stFlrSF"] = st.number_input(
        "1st Floor Area",
        value=float(numeric_defaults["1stFlrSF"])
    )

    user_data["2ndFlrSF"] = st.number_input(
        "2nd Floor Area",
        value=float(numeric_defaults["2ndFlrSF"])
    )

    user_data["TotalBsmtSF"] = st.number_input(
        "Basement Area",
        value=float(numeric_defaults["TotalBsmtSF"])
    )
...
with st.sidebar.expander(
    ...
    user_data["BedroomAbvGr"] = st.number_input(
        "Bedrooms",
        value=int(numeric_defaults["BedroomAbvGr"])
    )

    user_data["FullBath"] = st.number_input(
        "Full Bathrooms",
        value=int(numeric_defaults["FullBath"])
    )

    user_data["HalfBath"] = st.number_input(
        "Half Bathrooms",
        value=int(numeric_defaults["HalfBath"])
    )

    user_data["TotRmsAbvGrd"] = st.number_input(
        "Total Rooms",
        value=int(numeric_defaults["TotRmsAbvGrd"])
    )
...
with st.sidebar.expander(
    ...
    user_data["GarageCars"] = st.number_input(
        "Garage Capacity",
        value=int(numeric_defaults["GarageCars"])
    )

    user_data["GarageArea"] = st.number_input(
        "Garage Area",
        value=float(numeric_defaults["GarageArea"])
    )
...
with st.sidebar.expander(
    ...
    user_data["Neighborhood"] = st.selectbox(
        "Neighborhood",
        category_mapping["Neighborhood"]
    )

    user_data["MSZoning"] = st.selectbox(
        "Zoning",
        category_mapping["MSZoning"]
    )
